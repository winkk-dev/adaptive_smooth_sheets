...
class ExampleFormModal extends FormModal {
  /// Creates the example form modal.
  ExampleFormModal({super.key}) : super(
    formGroup: FormGroup({
      ...
      'supportContact': FormControl<String>(
  ...
  @override
  String title(BuildContext context) => 'Project brief';

  @override
  String subtitle(BuildContext context) {
    return 'Reactive form state spans body and footer';
  }

  @override
  String submitButtonLabel(BuildContext context) => 'Save brief';

  @override
  String submittingButtonLabel(BuildContext context) => 'Saving';
  ...
  Future<void> onSubmit(BuildContext context) async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(
          '${formGroup.control('projectName').value} project brief saved.',
        ),
      ),
    );
  }
